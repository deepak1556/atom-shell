...
ipcRenderer.on('ELECTRON_DEVTOOLS_ADD_EXTENSIONS', function (event, args) {
  window.InspectorFrontendAPI.addExtensions(args)
  window.WebInspector.extensionServer.initializeExtensions()
})
